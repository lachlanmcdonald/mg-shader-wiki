> **greebles2** is a **[primitive brush](Diagonal-Line-Brushes)** that generates greebles by randomly generating an uneven grid and then randomly intruding each cell.
